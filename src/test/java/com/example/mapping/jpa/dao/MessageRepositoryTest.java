package com.example.mapping.jpa.dao;

import com.example.mapping.jpa.model.Message;
import com.example.mapping.jpa.service.MessageService;
...
public class MessageRepositoryTest {
    ...
    public void testSave() {
        ...
        messages.add(Message.builder().msgText("orange").msgSummary("水果").build());
        messages.add(Message.builder().msgText("banana").msgSummary("水果").build());
    ...
    public void testDelete() {
        ...
        List<Message> messages = new ArrayList<>();
        messages.add(message);
        message = Message.builder().msgId(4)
                .msgText("computer").msgSummary("学习").build();
        messages.add(message);
        // 删除集合：一条一条删除
